  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${path}/admin/info/update.do">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" id="img1" name="logoimg" class="input tips" style="width:25%; float:left;" value="${info.logoimg}" data-toggle="hover" data-place="right"  data-image="<%=request.getContextPath()%>/file/${info.logoimg}"  />
